...
import com.jimmy.core.databinding.FragmentTabBinding;
 ...
 */
public class CoreFragmentTabActivity extends CoreActivity<FragmentTabBinding> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabManager = new TabManager(this, binding.tabhost, R.id.realtabcontent);
    ...
    public void addTab(String title, int indicatorView, Class<?> clss,
        ...
        mTabManager.addTab(
                binding.tabhost.newTabSpec(title).setIndicator(
                        new LabelIndicatorStrategy(this, title, indicatorView)
                                .createIndicatorView(binding.tabhost)), clss, args);
    }

    @Override
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        super.onRestoreInstanceState(savedInstanceState);
        binding.tabhost.setCurrentTabByTag(savedInstanceState.getString("tab"));
    }

    @Override
    protected void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        outState.putString("tab", binding.tabhost.getCurrentTabTag());
    }
    ...
    protected void setTabWidgetBackground(int drawableId) {
        if (drawableId > 0) {
            binding.tabhost.getTabWidget().setBackgroundResource(drawableId);
        }
    }
